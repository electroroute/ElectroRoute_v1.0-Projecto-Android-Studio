...
public class CreateComment_Rating extends Activity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.d("FECHAAAAAA", String.valueOf(c.getTime()));
    ...
    private void createCommment() {
        ...
        class newComment_Rating extends AsyncTask<String, String, String> {
            ...
            protected void onPreExecute() {
                ...
                pDialog.setMessage("Attempting comment...");
            ...
            protected String doInBackground(String... args) {
                ...
                try {
                    ...
                    params.add(new BasicNameValuePair("title", eliminarCaracteresEspeciales(title)));
                    Log.i("DATA COMMENT", title);
                    params.add(new BasicNameValuePair("comment", eliminarCaracteresEspeciales(comment)));
